...
export function PostDownloadModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4">
      ...
      <div
        ref={modalRef}
        className="relative w-full max-w-md border-2 sm:border-4 backdrop-blur-sm animate-in zoom-in-95 duration-200"
        style={{
      ...
      >
        ...
        >
          ...
          <button
            onClick={onClose}
            className="w-6 h-6 border-2 flex items-center justify-center transition-all duration-200 hover:scale-110 active:scale-95"
            style={{
