...
import { DynamicColorVariants } from "@/components/dynamic-color-variants"
...
export default function Page() {
  ...
  if (isLoading) {
    return <LoadingScreen onComplete={() => {
      setIsLoading(false)
      setShowWelcome(true) // Show welcome popup after loading
    }} />
  }
                ...
                <div className="space-y-6">
                  ...
                  <DynamicColorVariants 
                    ...
                    onColorVariantSelect={(variantId: string) => {
                      console.log(`🎨 Selected color variant: ${variantId} for part ${activePart}`);
                      onSelectAsset(activePart, variantId);
                    }}
                    isMobile={false} 
                  />
                </div>
            ...
            >
              <div className="space-y-4">
                ...
                <DynamicColorVariants 
                  ...
                  currentAssetId={selections[activePart]?.assetId || "default"} 
                  onColorVariantSelect={(variantId: string) => {
                    console.log(`🎨 Mobile: Selected color variant: ${variantId} for part ${activePart}`);
                    onSelectAsset(activePart, variantId);
                  }}
                  isMobile={true} 
                />
