...
const FALLBACK_CHARACTER_PARTS: PartDefinition[] = [
  ...
  },
  {
    ...
    assets: [
      ...
      {
        id: "tomboy-wineRed",
        name: "Tomboy (Wine Red) HAIR FRONT",
